...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ SellerTermsPage),
...
;// CONCATENATED MODULE: ./src/settings/terms-settings.ts
...
;// CONCATENATED MODULE: ./src/pages/seller-terms-and-conditions.tsx
        ...
        children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
          ...
          children: [/*#__PURE__*/jsx_runtime_.jsx("nav", {
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx("ol", {
              ...
              children: termsAndServices === null || termsAndServices === void 0 ? void 0 : termsAndServices.map((item, index) => /*#__PURE__*/jsx_runtime_.jsx("li", {
            ...
            className: "md:w-9/12 md:ps-8 ",
            children: termsAndServices === null || termsAndServices === void 0 ? void 0 : termsAndServices.map(item =>
            /*#__PURE__*/
            // @ts-ignore
...
SellerTermsPage.Layout = layout/* default */.Z;
const getStaticProps = async ({
  locale
}) => {
  return {
    props: _objectSpread({}, await (0,serverSideTranslations_.serverSideTranslations)(locale, ["common", "forms", "menu", "terms", "footer"]))
  };
};
...
var __webpack_exports__ = __webpack_require__.X(0, [8453,9583,9300,926,2095,239,6722], () => (__webpack_exec__(7520)));
